...
const About = () => {
  return (
    <div className="p-8 bg-gradient-to-br from-gray-100 to-gray-200 min-h-screen flex flex-col items-center">
      <h2 className="text-4xl font-extrabold text-center text-gray-800">About Srinivas Fireworks</h2>
      <p className="text-center text-gray-600 mt-2 text-lg">
        Celebrating moments with the brightest fireworks since <span className="font-semibold">[Year of Establishment]</span>.
      </p>
      ...
      <div className="max-w-3xl mt-6 p-6 border border-gray-300 rounded-xl shadow-xl bg-white transition-transform duration-300 hover:scale-105">
        ...
        <p className="mt-2 text-gray-600 leading-relaxed">
          ...
          memorable. Based in <span className="font-semibold">Sivakasi</span>, the heart of India's fireworks industry, we 
        ...
        <p className="mt-2 text-gray-600 leading-relaxed">
          ...
          🌿 <span className="font-semibold text-gray-700">Eco-Friendly:</span> We strive to create fireworks with minimal environmental impact. <br />
        ...
        <p className="mt-2 text-gray-600">
          ...
          📧 <strong className="text-gray-800">Email:</strong> info@srinivasfireworks.com
        </p>
      </div>
    </div>
  );
